...
var _process_source = Module['_process_source'] = makeInvalidEarlyAccess('_process_source');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['process_source'] != 'undefined', 'missing Wasm export: process_source');
  ...
  _process_source = Module['_process_source'] = createExportWrapper('process_source', 1);
